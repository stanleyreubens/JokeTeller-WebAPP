...
var VoiceRSS={speech:function(e){this._validate(e),this._request(e)},_validate:function(e){
    ...
    if(e.c&&"auto"!=e.c.toLowerCase()){
        ...
        case"caf":
            a=(new Audio).canPlayType("audio/x-caf").replace("no","")}if(!a)throw"The browser does not support the audio codec "+e.c}},_request:function(e){var a=this._buildRequest(e),t=this._getXHR();
...
function tellMe(joke) {
    VoiceRSS.speech({
        key: 'ffbb42f991ce464ea6447616f0f869a4',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
